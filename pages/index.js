  ...
  return (
    ...
    <IndexNavbar fixed />
      <section className="header relative pt-16 items-center flex h-screen max-h-860-px">
          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              ...
              <p className="mt-4 text-lg leading-relaxed text-gray-600">
                Lead UI/UX Designer @ BigRadar{" "}
              </p>
              <div className="mt-12">
                <a
                  href="/blog"
                  className="get-started text-white font-bold px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-1 bg-black active:bg-gray-700 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150"
                >
                  View Blog
                </a>
              </div>
        ...
        <img
          className="absolute top-20 b-auto right-0 pt-16 sm:w-6/12 -mt-48 sm:mt-0 w-90/12 max-h-860-px"
